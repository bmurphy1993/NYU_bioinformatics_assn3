...
CountTable <- read.table("t2g_output.txt", header=TRUE, row.names=1) 
...
png(filename = "C:/Users/bmurp/OneDrive/Desktop/NYU/Classes/Fall_2020/Bioinformatics/03_Crash_Course_in_Gene_Expression/Assignments/bp_outputs/Figs/Kallisto_PCA.png")
...
png(filename = "C:/Users/bmurp/OneDrive/Desktop/NYU/Classes/Fall_2020/Bioinformatics/03_Crash_Course_in_Gene_Expression/Assignments/bp_outputs/Figs/Kallisto_PCA_2.png")
...
png(filename = "C:/Users/bmurp/OneDrive/Desktop/NYU/Classes/Fall_2020/Bioinformatics/03_Crash_Course_in_Gene_Expression/Assignments/bp_outputs/Figs/Kallisto_DistMat.png")
pheatmap(sampleDistMatrix, clustering_distance_rows=sampleDists, clustering_distance_cols=sampleDists, col=colors, main = "Kallisto Sample Distance Matrix")
dev.off()
...
png(filename = "C:/Users/bmurp/OneDrive/Desktop/NYU/Classes/Fall_2020/Bioinformatics/03_Crash_Course_in_Gene_Expression/Assignments/bp_outputs/Figs/Kallisto_DistMat_corrected.png")
pheatmap(sampleDistCorrMatrix, clustering_distance_rows=sampleDists, clustering_distance_cols=sampleDists, col=colors, main = "Kallisto Sample Distance Matrix (Corrected)")
dev.off()
...
png(filename = "C:/Users/bmurp/OneDrive/Desktop/NYU/Classes/Fall_2020/Bioinformatics/03_Crash_Course_in_Gene_Expression/Assignments/bp_outputs/Figs/Kallisto_MeanCounts.png")
plotMA(DatasetProcessed, main="Kallisto DESeq2", ylim=c(-5,5))
dev.off()
...
### VOLCANO PLOTS
png(filename = "C:/Users/bmurp/OneDrive/Desktop/NYU/Classes/Fall_2020/Bioinformatics/03_Crash_Course_in_Gene_Expression/Assignments/bp_outputs/Figs/Kallisto_volcano.png")
Dataset$Condition <- relevel(Dataset$Condition, "Ctrl")
res1 <- lfcShrink(DatasetProcessed, contrast=c("Condition","dsDNA","Ctrl"), type = "ashr")
with(res1, plot(log2FoldChange, -log10(pvalue), pch=16, cex=1.5, main="Kallisto Volcano Plot", xlim=c(-5,5)))
...
png(filename = "C:/Users/bmurp/OneDrive/Desktop/NYU/Classes/Fall_2020/Bioinformatics/03_Crash_Course_in_Gene_Expression/Assignments/bp_outputs/Figs/Kallisto_heatmap.png")
pheatmap(mat, cluster_rows=TRUE, show_rownames=TRUE, cluster_cols=TRUE, annotation_col=df, main = "Kallisto Heatmap")
dev.off()